...
class RecruitmentStatusReport extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
          ...
          <CCol xs="12" sm="12">
            <CCard>
              <CCardHeader>
                ...
                >
                  <h4>Recruitment Status Report</h4>
                </div>
              </CCardHeader>
              <CCard>
                {this.state.postMsg ? (
                    ...
                    <Row gutter={20}>
                      <Col span={12}>
                        <CFormGroup>
                          <Col>
                            <CLabel>
                              <b>Status on Vacancy</b>
                            </CLabel>
                          </Col>
                          <Col>
                            <CSelect
                              name="statusVacancyId"
                              placeholder="Select"
                              onChange={this.handleChange}
                              value={obj.statusVacancyId || ""}
                              invalid={errors.jobAssocId ? true : false}
                            >
                              <option value="0">-Select-</option>
                              <option value="1">Vacancy</option>
                              <option value="2">Recruitment Status </option>
                            </CSelect>
                            <FormFeedback>{errors.jobAssocId}</FormFeedback>
                          </Col>
                        </CFormGroup>
                      ...
                      >
                        <thead>
                          <tr>
                            ...
                            <th>Number of Sanctioned Posts (old)</th>
                            <th>Number of In-Place Position (old)</th>
                            <th>Number of Vacant Posts (old)</th>
                            <th>Number of Sanctioned Posts (New)</th>
                            <th>Number of In-Place Position (New)</th>
                            <th>Number of Vacant Posts (new)</th>
                            <th>Total Number of Sanctioned Posts (old+new)</th>
                            <th>Total Number of In-Place Position (old+new)</th>
                            <th>Total Number of Vacant Posts (old+new)</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <CInput
                                ...
                                onChange={this.handleChange}
                                invalid={
                                  errors.noApplicantShotUR ? true : false
                                }
                              />
                              <FormFeedback>{errors.noAppRecUR}</FormFeedback>
                            </td>
                      ...
                      >
                        <thead>
                          <tr>
                            ...
                            <th>Number of Vacant Posts from Previously Sanctioned (Old)</th>
                            <th>Number of Vacant from newly Sanctioned (New)</th>
                            <th>Total Number of Posts required to filed (Old and New Vacancy together)</th>
                            <th>Number of posts to be advertised</th>
                            <th>Details on the post advertise</th>
                            <th>Number of Post for which advertisement issued</th>
                            <th>Number of application received</th>
                            <th>Number of applicants shortlisted</th>
                            <th>Number of applicants Appears selection process</th>
                            <th>Number of applicants Selected</th>
                            <th>Number of offer letter issued to applicant</th>
                            <th>Number of applicants joined</th>
                            <th>Number of applicant on wait list</th>
                            <th>Number of applicants not joined (including issuing offer letter from waitlist also)</th>
                            <th>Number of applicants resigned</th>
                            <th>Number of applicant terminated</th>
                            <th>Total Number of applicants still working (Joined-Resigned- Terminated</th>
                            <th>Nos. of position required to re-advertised ( Required to filled- still working)</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                    ...
                    <Row gutter={20}>
                      <Col span={12}>
                        <CFormGroup>
                          <Col>
                            <CLabel>
                              <b>Duration of the recruitment process completed i.e. from date of advertisement issued to till last person joined</b>
                            </CLabel>
                          </Col>
                          <Col>
                            <CInput
