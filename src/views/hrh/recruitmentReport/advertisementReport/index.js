...
export class AdvertisementReportDetails extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
  ...
  newCollector = () => {
    if (this.state.role === "admin_role") {
      this.props.history.push({
        pathname: "/hrh/recruitmentReports/AdvsertisementStatusReportNational",
      });
    } else {
      this.props.history.push({
        pathname: "/hrh/recruitmentReports/AdvsertisementStatusReport",
          ...
          <CCol xs="12" sm="12">
            <CCard>
              <CCardHeader>
                ...
                >
                  {role === "admin_role" ? (
                    <h4>Advertisement Status Report-National</h4>
                  ) : role === "state_role" ? (
                    <h4>Advertisement Status Report - State</h4>
                  ) : (
                    <h4>Advertisement Status Report - District</h4>
                  )}
                </div>
              </CCardHeader>
              <CCard>
