                    ...
                    <Row gutter={20}>
                      <Col span={12}>
                        <CFormGroup>
                          <Col>
                            <CLabel>
                              <b>Number of staff who did not meet the required performance benchmarks on most of the indicators</b>
                            </CLabel>
                          </Col>
                          <Col>
                            <CInput
                      ...
                      <Col span={12}>
                        <CFormGroup>
                          <Col>
                            <CLabel>
                              <b>
                              Number of staff who met the required performance benchmarks on few of the indicators
                              </b>
                            </CLabel>
                          </Col>
                          <Col>
                      ...
                      <Col span={12}>
                        <CFormGroup>
                          <Col>
                            <CLabel>
                              <b>
                              Number of staff who met the required performance benchmarks on most of the indicators
                              </b>
                            </CLabel>
                          </Col>
                          <Col>
                      ...
                      <Col span={12}>
                        <CFormGroup>
                          <Col>
                            <CLabel>
                              <b>
                              Number of staff who met all the required performance benchmarks
                              </b>
                            </CLabel>
                          </Col>
                          <Col>
