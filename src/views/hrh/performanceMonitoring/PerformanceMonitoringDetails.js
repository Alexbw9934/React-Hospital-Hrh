...
class PerformanceMonitoringDetails extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
  ...
  componentDidMount() {
    ...
    axios({
      url: `${process.env.REACT_APP_API_URL}performanceMonitoring`,
      method: "GET",
    }).then((response) => {
  ...
  StoreCollector = (id) => {
    this.props.history.push({
      pathname: "/hrh/performanceMonitoring/PerformanceMonitoring",
      state: {
        data: id,
      },
    });
