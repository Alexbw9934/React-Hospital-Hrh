...
class AnnexureVacancyDistrict extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
              ...
              <CCard>
                ...
                <CCardBody>
                  <CForm onSubmit={this.handleSubmit}>
                    ...
                    >
                      <thead>
                        <tr>
                            ...
                            <th rowSpan={2}>Type of Post</th>
                            <th rowSpan={2}>Place of Post</th>
                            <th rowSpan={2}>Type of Office/Facility</th>
                            <th rowSpan={2}>Name of Post</th>
                            <th rowSpan={2}>Type of Job Association</th>
                            <th colSpan={6}>Number of Sanctioned Posts(old)</th>
                            <th colSpan={6}>Number of In-place Positiion(old)</th>
                            <th colSpan={6}>Number of Vaccant post new</th>
                            <th colSpan={6}>Number of Sanctioned post (old+new)</th>
                            <th colSpan={6}>Number of In-place Positiion(old+new)</th>
                            <th colSpan={6}>Number of Vaccant post(old+new)</th>
                        </tr>
                        <tr>
                            <th>UR</th>
                            <th>OBC</th>
                    ...
                    <Button className="mb-3">Add Line</Button>
                    <Row>
                      <Col>
                        <Form.Item>
                          <Button
