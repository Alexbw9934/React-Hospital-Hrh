...
export class SDNHMDetails extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
      ...
      columnsNational: [
        ...
        },
        {
          ...
          key: "action",
          render: (text, record) => (
              <Link to={{pathname: `/hrh/humanResourceProposalReports/SDNHM`, state: { data: record.id}}}>
              <CButton
                style={{ backgroundColor: "blue" }}
                // onClick={(e) => this.StoreCollector(e, record.id)}
              >
  ...
  newCollector = () => {
   ...
   { this.props.history.push({
      pathname: "/hrh/humanResourceProposalReports/SDNHM",
        ...
        this.props.history.push({
            pathname: "/hrh/humanResourceProposalReports/SDNHMState",
          }); 
    }
  };
  render() {
