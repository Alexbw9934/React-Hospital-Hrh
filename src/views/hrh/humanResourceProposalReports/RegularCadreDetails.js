...
export class RegularCadreDetails extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
      ...
      columnsNational: [
        ...
        },
        {
          ...
          key: "action",
          render: (text, record) => (
              <Link to={{pathname: `/hrh/humanResourceProposalReports/RegularCadre`, state: { data: record.id}}}>
              <CButton
                style={{ backgroundColor: "blue" }}
                // onClick={(e) => this.StoreCollector(e, record.id)}
              >
  ...
  StoreCollector = (id) => {
    this.props.history.push({
      pathname: "/hrh/humanResourceProposalReports/RegularCadre",
      state: {
        data: id,
      },
    });
          ...
          <CCol xs="12" sm="12">
            <CCard>
              <CCardHeader>
                ...
                >
                  {role === "admin_role" ? (
                    <h4>Regular Cadre-National</h4>
                  ) : role === "state_role" ? (
                    <h4>Regular Cadre - State Details</h4>
                  ) : (
                    <h4>Regular Cadre - District</h4>
                  )}
                </div>
              </CCardHeader>
              <CCard>
