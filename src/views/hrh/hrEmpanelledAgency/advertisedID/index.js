...
class AdvertisedIDDetails extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
  ...
  newCollector = () => {
    this.props.history.push({
      pathname: "/hrh/hrEmpanelledAgency/advertisedID",
    });
  };
  render() {
          ...
          <CCol xs="12" sm="12">
            <CCard>
              <CCardHeader>
                ...
                >
                  {role == "admin_role" ? (
                    <h4>Recruitment Status Report Advertisement ID-National</h4>
                  ) : role == "state_role" ? (
                    <h4>Recruitment Status Report Advertisement ID- State Details</h4>
                  ) : (
                    <h4>Recruitment Status Report Advertisement ID- District</h4>
                  )}
                </div>
              </CCardHeader>
              <CCard>
