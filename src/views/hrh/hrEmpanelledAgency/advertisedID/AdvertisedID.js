...
class AdvertisedID extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
          ...
          <CCol xs="12" sm="12">
            <CCard>
              <CCardHeader>
                ...
                >
                  <h4>Recruitment Status Report Advertisement ID</h4>
                </div>
              </CCardHeader>
              <CCard>
                {this.state.postMsg ? (
                  ...
                  <CForm onSubmit={this.handleSubmit}>
                    ...
                    <Row gutter={20}>
                      ...
                      <Col span={12}>
                        <CFormGroup>
                          <Col md="12">
                            <CLabel htmlFor="text-input">
                              <b>Select the Advertised Id numbers</b>
                            </CLabel>
                          </Col>
                          <Col>
                            <CSelect
                        ...
                        <CFormGroup>
                          ...
                          <Col>
                            ...
                            >
                              ...
                              <option value="3">Both SD and PM</option>
                            </CSelect>
                            <FormFeedback>{errors.reportingPriod}</FormFeedback>
                          </Col>
                        </CFormGroup>
                    ...
                    <table className="table table-bordered">
                      <thead>
                        ...
                        <tr>
                          <th>Newspapers (Yes/No)</th>
                          <th>Nos. of Newspapers</th>
                          <th>Website of NHM(Yes/No)</th>
                          <th>Job searching site(Yes/No)</th>
                          <th>If Yes please provide the sitename</th>
                          <th>Social media site (Yes/No)</th>
                          <th>If Yes please provide the sitename</th>
                        </tr>
                      </thead>
                      <tbody>
                    ...
                    <table className="table table-bordered">
                      <tbody>
                        ...
                        <tr>
                          <th>Nos. of Application Received</th>
                          <td>
                            <CInput
                              type="number"
                              placeholder="UR"
                        ...
                        <tr>
                          ...
                          <td colSpan={5}>
                            ...
                            >
                              ...
                              <Radio value="2">Interview</Radio>
                              <Radio value="3">Skill Test</Radio>
                              <Radio value="4">Total wise</Radio>
                            </Radio.Group>
                          </td>
                        </tr>
                        <tr>
                          <th>
                            Nos. of Applicant Appears for selection process
                          </th>
                          <td>
                            <CInput
                              type="number"
                        ...
                        <tr>
                          <th>Nos. of Applicant Selected</th>
                          <td>
                            <CInput
                              type="number"
                              placeholder="UR"
                        ...
                        <tr>
                          <th>Nos. of Applicant Not Joined</th>
                          <td>
                            <CInput
                              type="number"
                              placeholder="UR"
                        ...
                        <tr>
                          <th>Status of Applicant Working</th>
                          <td>
                            <CInput
                              type="number"
                        ...
                        <tr>
                          <th>Nos. of Applicant left job</th>
                          <td>
                            <CInput
                              type="number"
                              placeholder="1-3 Months"
                        ...
                        <tr>
                          <th>
                            Nos. of Posts required to re-advertised(Auto
                            calculate Total Select- Left Job)
                          </th>
                          <td>
                            <CInput
                              type="number"
                        ...
                        <tr>
                          <th>Monthly Salary Offered (In INR)</th>
                          <td>
                            <CFormGroup>
                              <CInput type="number" value={obj.salary} />
                            </CFormGroup>
                          </td>
                          <th>Remark please provide</th>
                          <td>
                            <CFormGroup>
                              <CInput
                                placeholder="Not Joining after selection"
                                value={obj.salary}
                              />
                            </CFormGroup>
                          </td>
                          <td>
                            <CFormGroup>
                              <CInput
                                placeholder="Left Job or Terminated"
                                value={obj.salary}
                              />
                            </CFormGroup>
                          </td>
...
export default connect(mapStateToProps, mapDispatchToProps)(AdvertisedID);
