...
export class HumanResourceProposalDetails extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
  ...
  componentDidMount() {
    ...
    axios({
      ...
      let arr2=response.data.filter(data=>data.formStatus==4 && data.stateStatus==4)
      this.setState({ users: response.data });
      this.setState({ userState: arr});
      this.setState({ userDistrict: arr2});
    });
    axios({
                ...
                <CCardBody>
                  {role == "admin_role" ? (
                    ...
                    <Table
                      ...
                      rowKey={"id"}
                      columns={this.state.columnDistrict}
                    />
                  )}
                </CCardBody>
              </CCard>
