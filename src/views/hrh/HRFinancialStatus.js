...
class HRFinancialStatus extends Component {
  constructor() {
    super();
    this.state = {
      country: "",
                ...
                <CCardBody>
                  <CForm onSubmit={this.handleSubmit}>
                    ...
                    <Row gutter={20}>
                      ...
                      {obj.financialYear>0 ?<Col span={12}>
                        <CFormGroup>
                          <Col md="12">
                            <CLabel htmlFor="text-input">
                          ...
                          <Col>
                            <Radio.Group
                              onChange={(e) =>
                                this.setState({
                                  obj: {
                                    ...this.state.obj,
                                    financialYearRad: e.target.value,
                                  },
                                })
                              }
                              value={obj.financialYearRad || ""}
                            >
                               {this.props.financialYearList &&
                                this.props.financialYearList.filter(data=>obj.financialYear===data.id).map(
                                  (item, index) => {
                                    return (
                              <Radio value="1" key={index}> {`${new Date(
                                item.fromDate
                              ).getFullYear()}-${parseInt((Number(new Date(
                                item.fromDate
                              ).getFullYear())+Number(new Date(
                                item.toDate
                              ).getFullYear()))/2)}`}</Radio>
                              );
                            }
                           ...
                           {this.props.financialYearList &&
                                this.props.financialYearList.filter(data=>obj.financialYear===data.id).map(
                                  (item, index) => {
                                    return (
                              <Radio value="2" key={index}> {`${parseInt((Number(new Date(
                                item.fromDate
                              ).getFullYear())+Number(new Date(
                                item.toDate
                              ).getFullYear()))/2)}- ${new Date(
                                item.toDate
                              ).getFullYear()}`}</Radio>
                              );
                            }
                      ...
                      <Col span={12}>
                        ...
                        <table className="table table-bordered table-sm">
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <b>Service Delivery HRH (SD-HRH)</b>
                              </td>
                              <td>
                                {" "}
                                <CSelect
                            ...
                            <tr>
                              <td>
                                <b>Programme Management HRH (PM-HRH)</b>
                              </td>
                              <td>
                                {" "}
                                <CSelect
                            ...
                            <tr>
                              <td>
                                <b>Budget for data entry operation (PM-DEO)</b>
                              </td>
                              <td>
                                {" "}
                                <CSelect
                            ...
                            <tr>
                              <td>
                                <b>
                                  Budget for engaging support services on
                                  outsource basis/ Support Staff at facility
                                  level(SD-SS)
                                </b>
                              </td>
                              <td>
                            ...
                            <tr>
                              <td>
                                <b>
                                  Budget for engaging support services on
                                  outsource basis/ Support Staff in
                                  offices(PM-SS)
                                </b>
                              </td>
                              <td>
                            ...
                            <tr>
                              <td>
                                <b>
                                  Annual Increment and rationalization budget
