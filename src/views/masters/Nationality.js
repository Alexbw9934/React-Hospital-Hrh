...
function Nationality() {
  ...
  function listApi() {
    axios.get("http://5.9.111.198:13880/api/Nationalities").then((res) => {
  ...
  function submitData(e) {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        fetch("http://5.9.111.198:13880/api/Nationalities", {
          method: "POST",
          headers: {
  ...
  function editForm(id) {
    ...
    setEditValue({});
    axios
      .get(`http://5.9.111.198:13880/api/Nationalities/${id}`)
      .then((res) => {
        console.log(res.data);
        let data = res.data;
        setEditValue(data);
  ...
  function updateData(e, id) {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        setCheckingMsg(false);
        fetch(`http://5.9.111.198:13880/api/Nationalities/${id}`, {
          method: "PUT",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      <CRow>
        <CCol xs="12" sm="12">
          <CCard>
            ...
            <CCard>
              <CCardHeader>Natiionality List</CCardHeader>
              <CCardBody>
                <Table
