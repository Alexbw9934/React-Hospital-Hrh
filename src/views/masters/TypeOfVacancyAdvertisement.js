...
import { retrieveTypeOfVacancyAdvertisement } from "../../actions/apiadd";
...
class TypeOfVacancyAdvertisement extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      value: {
  ...
  submitData = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        fetch("http://5.9.111.198:13880/api/TypeofVacancyAdvertisements", {
          method: "POST",
          headers: {
  ...
  editForm = (id) => {
    ...
    axios
      .get(`http://5.9.111.198:13880/api/TypeofVacancyAdvertisements/${id}`)
      .then((res) => {
  ...
  updateData = (e, id) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        fetch(
          `http://5.9.111.198:13880/api/TypeofVacancyAdvertisements/${id}`,
          {
            method: "PUT",
            headers: {
              Accept: "application/json",
      ...
      <div>
        <CRow>
          <CCol xs="12" sm="12">
            <CCard>
              <CCardHeader>
                <h4>Type Of Vacancy Advertisement</h4>
              </CCardHeader>
              <CCardBody>
                    ...
                    <CFormGroup row>
                      ...
                      <CCol xs="12" sm="12">
                        <CInput
                          id="name"
                          name="name"
                          placeholder="Type Of Vacancy Advertisement"
        ...
        <div>
          <CRow>
            <CCol xs="12" sm="12">
              <CCard>
                <CCardHeader>
                  <h4>Type Of Vacancy Advertisement List</h4>
                </CCardHeader>
                <CCardBody>
                  <Table
                    dataSource={this.props.typeofVacancyAdverstisementList.sort(
                      (a, b) => (a.id < b.id ? 1 : -1)
                    )}
                    rowKey={"id"}
                  >
                    ...
                    ></Table.Column>
                    <Table.Column
                      title="Type Of Vacancy Advertisement"
                      dataIndex="name"
                      key="name"
                    ></Table.Column>
                    <Table.Column
