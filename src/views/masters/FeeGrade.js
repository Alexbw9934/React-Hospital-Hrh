...
function FeeGrade() {
  ...
  function listApi() {
    axios.get("http://5.9.111.198:13880/api/FeeGrades").then((res) => {
  ...
  function submitData(e) {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        fetch("http://5.9.111.198:13880/api/FeeGrades", {
          method: "POST",
          headers: {
  ...
  function editForm(id) {
    ...
    setErrors({});
    setEditValue({});
    axios.get(`http://5.9.111.198:13880/api/FeeGrades/${id}`).then((res) => {
      console.log(res.data);
      let data = res.data;
      setEditValue(data);
    });
  ...
  function updateData(e, id) {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        setCheckingMsg(false);
        fetch(`http://5.9.111.198:13880/api/FeeGrades/${id}`, {
          method: "PUT",
          headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
      ...
      <CRow>
        <CCol xs="12" sm="12">
          <CCard>
            ...
            <CCard>
              <CCardHeader>Fee Grade List</CCardHeader>
              <CCardBody>
              <Table
