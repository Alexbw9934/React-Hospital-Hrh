...
function TypeofPost(props) {
  ...
  const [editValue, setEditValue] = useState({ id: 0, name: "",programTypeId:0, masterStatus: 0 });
  ...
  }, [postMsg,updateMsg,checkingMsg,checkStatus]);

  function listApi() {
    axios.get(`${process.env.REACT_APP_API_URL}TypeofPosts`).then((res) => {
  ...
  function submitData(e) {
    ...
    if (Object.keys(errors).length == 0) {
      ...
      if (check.includes(false)) {
        ...
        console.log("TypeofPosts", data);
        fetch(`${process.env.REACT_APP_API_URL}TypeofPosts`, {
          method: "POST",
          headers: {
  ...
  function editForm(id) {
    ...
    setErrors({});
    axios
      .get(`${process.env.REACT_APP_API_URL}TypeofPosts/${id}`)
      .then((res) => {
        console.log(res.data);
        let data = res.data;
        setEditValue(data);
      ...
      <CRow>
        <CCol xs="12" sm="12">
          <CCard>
            ...
            <CCardBody>
              ...
              {edit ? (
                ...
                >
                  <CFormGroup row>
                    <CCol md="4">
                      <CLabel htmlFor="text-input"><b>Type Of Post</b> </CLabel>
                    </CCol>
                    <CCol xs="12" sm="12">
                      <CInput
                        id="form"
            ...
            <CCard>
              <CCardHeader>Type of Post List</CCardHeader>
              <CCardBody>
              <Table
...
export default connect(mapStateToProps, mapDispatchToProps)(TypeofPost);
