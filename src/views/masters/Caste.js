...
function Caste() {
  ...
  function listApi() {
    axios.get("http://5.9.111.198:13880/api/Castes").then((res) => {
  ...
  function submitData(e) {
    ...
    if (Object.keys(errors).length == 0) {
      ...
      if (check.includes(false)) {
        ...
        fetch("http://5.9.111.198:13880/api/Castes", {
          method: "POST",
          headers: {
  ...
  function editForm(id) {
    ...
    setErrors({});
    setEditValue({});
    axios.get(`http://5.9.111.198:13880/api/Castes/${id}`).then((res) => {
      console.log(res.data);
      let data = res.data;
      setEditValue(data);
    });
      ...
      <CRow>
        <CCol xs="12" sm="12">
          <CCard>
            ...
            <CCardBody>
              ...
              {edit ? (
                ...
                >
                  <CFormGroup row>
                  <CCol md="2">
                      <CLabel htmlFor="text-input"> <b>Caste</b></CLabel>
                    </CCol>
                    <CCol xs="12" sm="12">
                      <CInput
                        id="form"
            ...
            <CCard>
              <CCardHeader>Caste List</CCardHeader>
              <CCardBody>
              <Table
