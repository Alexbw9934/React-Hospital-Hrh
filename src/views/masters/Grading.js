...
import { retrieveGrading } from "../../actions/apiadd";
...
class Grading extends React.Component {
  ...
  submitData = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (check.includes(false)) {
        ...
        fetch("http://5.9.111.198:13880/api/Gradings", {
          method: "POST",
          headers: {
  ...
  editForm = (id) => {
    ...
    axios.get(`http://5.9.111.198:13880/api/Gradings/${id}`).then((res) => {
              ...
              <CCardBody>
                ...
                {this.state.edit ? (
                  ...
                  >
                    <CFormGroup row>
                      <CCol md="4">
                        <CLabel htmlFor="text-input">Grading</CLabel>
                      </CCol>
                      <CCol xs="12" sm="12">
                        <CInput
                          id="name"
            ...
            <CCol xs="12" sm="12">
              <CCard>
                <CCardHeader>
                  ...
                  <CCardBody>
                  <Table
                    dataSource={this.props.gradingList.sort((a, b) =>
                      a.id < b.id ? 1 : -1
                    )}
                    rowKey={"id"}
                  >
...
const mapStateToProps = (state) => {
  return {
    gradingList: state.apiadd.gradingList,
  };
};
